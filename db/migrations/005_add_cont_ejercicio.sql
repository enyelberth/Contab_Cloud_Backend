/* ================================================================
   MIGRATION 005 — Agregar tabla cont_ejercicio a todos los tenants
   - Crea cont_ejercicio en tenants existentes
   - Recrea sp_create_tenant_schema incluyendo cont_ejercicio
================================================================ */

-- 1. Agregar cont_ejercicio a tenants existentes
DO $$
DECLARE
    r RECORD;
BEGIN
    ...
    LOOP
        IF NOT EXISTS (
            ...
            WHERE table_schema = r.schema_name AND table_name = 'cont_ejercicio'
        ) THEN
            EXECUTE format('
                CREATE TABLE %I.cont_ejercicio (
...
-- 2. Recrear el procedure con todas las tablas contables incluidas
...
VALUES('20260405_005', 'Agregar tabla cont_ejercicio a todos los tenants', current_user)
